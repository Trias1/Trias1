...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=700&size=24&duration=2800&pause=900&color=22D3EE&center=true&vCenter=true&width=720&lines=Full-Stack+Developer;Dashboard+%26+Internal+Tools+Builder;Backend+%26+API+Enthusiast;Clean+UI+%2B+Maintainable+Code" alt="Typing SVG" />
</p>
...
I build practical web applications, dashboards, backend services, and mobile experiments with a focus on clean structure, usability, and maintainable code.
...
| Project | What it is |
| --- | --- |
| **Launchpad** | Private product planning workspace and handoff system. |
| **DevDock** | Developer workspace for notes, snippets, utilities, and API testing. |
| **QuranBest** | Modern Quran reading experience. |
...
- Improving full-stack product workflows
- Building cleaner dashboards and internal tools
